        ...
        <div className="max-w-7xl mx-auto">
          ...
          {activeSection === "overview" && (
            <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Hash Maps Overview</h2>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-2xl font-semibold text-indigo-600 mb-4">What are Hash Maps?</h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-indigo-600 mb-4">Core Operations</h3>
                  <div className="space-y-4">
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                      <h4 className="text-cyan-400 mb-2">put(key, value)</h4>
                      <p className="text-gray-700">Insert or update key-value pair</p>
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                      ...
                      <p className="text-gray-700">Retrieve value associated with key</p>
                      <pre className="bg-gray-900 text-gray-100 p-2 rounded text-xs mt-2 border border-gray-700">
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                      ...
                      <p className="text-gray-700">Check if key exists in map</p>
                      <pre className="bg-gray-900 text-gray-100 p-2 rounded text-xs mt-2 border border-gray-700">
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                      ...
                      <p className="text-gray-700">Remove key-value pair from map</p>
                      <pre className="bg-gray-900 text-gray-100 p-2 rounded text-xs mt-2 border border-gray-700">
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-indigo-900/20 to-purple-900/20 border border-indigo-700/50 p-6 rounded-xl">
                  <h4 className="text-xl font-semibold text-indigo-600 mb-3">Average Performance</h4>
          ...
          {activeSection === "implementations" && (
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Hash Map Implementations</h2>
          ...
          {activeSection === "operations" && (
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Hash Map Operations</h2>
          ...
          {activeSection === "applications" && (
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Hash Map Applications</h2>
              ...
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="bg-gray-100 p-3 rounded">
                    ...
                    <div className="text-gray-600">Randomized functions with worst-case guarantees</div>
                  </div>
                </div>
              </div>
            </div>
