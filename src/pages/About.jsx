    ...
    <Layout showNavbar={true}>
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Mission Section */}
          <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-700 p-6 sm:p-8 mb-8 sm:mb-12 transition-all duration-300 hover:border-emerald-500 hover:shadow-xl hover:shadow-emerald-500/10">
            <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
              <div className="md:w-1/2">
                <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4 transition-all duration-300 hover:text-emerald-400">Our Mission</h2>
              ...
              <div className="md:w-1/2">
                <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-emerald-500/20 transition-all duration-300 hover:border-emerald-500 hover:shadow-lg hover:shadow-emerald-500/20">
                  <div className="text-center">
                    <div className="text-4xl sm:text-5xl font-bold text-emerald-400 mb-2 transition-all duration-300 hover:text-emerald-300">10K+</div>
                  ...
                  <div className="flex flex-col sm:flex-row justify-between gap-4 sm:gap-0 mt-6">
                    <div className="text-center group">
                      <div className="text-xl sm:text-2xl font-bold text-blue-400 transition-all duration-300 group-hover:text-blue-300">500+</div>
                      <div className="text-gray-400 text-sm transition-all duration-300 group-hover:text-gray-300">Coding Problems</div>
                    </div>
                    <div className="text-center group">
                      <div className="text-xl sm:text-2xl font-bold text-purple-400 transition-all duration-300 group-hover:text-purple-300">50+</div>
                      <div className="text-gray-400 text-sm transition-all duration-300 group-hover:text-gray-300">Expert Instructors</div>
                    </div>
                    <div className="text-center group">
                      <div className="text-xl sm:text-2xl font-bold text-cyan-400 transition-all duration-300 group-hover:text-cyan-300">95%</div>
          ...
          <div className="mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-white text-center mb-8 sm:mb-12 transition-all duration-300 hover:text-emerald-400">Our Core Values</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-700 p-4 sm:p-6 transition-all duration-300 hover:border-emerald-500 hover:shadow-xl hover:shadow-emerald-500/10 transform hover:-translate-y-2 hover:scale-105">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white mb-2 transition-all duration-300 hover:text-emerald-400">Innovation</h3>
              ...
              <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-700 p-4 sm:p-6 transition-all duration-300 hover:border-blue-500 hover:shadow-xl hover:shadow-blue-500/10 transform hover:-translate-y-2 hover:scale-105">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white mb-2 transition-all duration-300 hover:text-blue-400">Community</h3>
                <p className="text-gray-400 transition-all duration-300 hover:text-gray-300">
                  We believe in the power of collaborative learning and peer support.
                </p>
              </div>

              <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-700 p-4 sm:p-6 transition-all duration-300 hover:border-purple-500 hover:shadow-xl hover:shadow-purple-500/10 transform hover:-translate-y-2 hover:scale-105">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white mb-2 transition-all duration-300 hover:text-purple-400">Excellence</h3>
                <p className="text-gray-400 transition-all duration-300 hover:text-gray-300">
                  We strive for the highest standards in content quality and user experience.
                </p>
              </div>

              <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-700 p-4 sm:p-6 transition-all duration-300 hover:border-cyan-500 hover:shadow-xl hover:shadow-cyan-500/10 transform hover:-translate-y-2 hover:scale-105">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white mb-2 transition-all duration-300 hover:text-cyan-400">Accessibility</h3>
                <p className="text-gray-400 transition-all duration-300 hover:text-gray-300">
          ...
          {/* Team Section */}
          <div className="mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-white text-center mb-8 sm:mb-12 transition-all duration-300 hover:text-emerald-400">Meet Our Leadership</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-700 p-4 sm:p-6 text-center transition-all duration-300 hover:border-emerald-500 hover:shadow-xl hover:shadow-emerald-500/10 transform hover:-translate-y-2 hover:scale-105">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white transition-all duration-300 hover:text-emerald-400">Alex Johnson</h3>
              ...
              <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-700 p-4 sm:p-6 text-center transition-all duration-300 hover:border-blue-500 hover:shadow-xl hover:shadow-blue-500/10 transform hover:-translate-y-2 hover:scale-105">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white transition-all duration-300 hover:text-blue-400">Sarah Chen</h3>
              ...
              <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-700 p-4 sm:p-6 text-center transition-all duration-300 hover:border-purple-500 hover:shadow-xl hover:shadow-purple-500/10 transform hover:-translate-y-2 hover:scale-105">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white transition-all duration-300 hover:text-purple-400">Michael Rodriguez</h3>
