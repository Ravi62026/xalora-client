        ...
        <Layout>
            <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black py-8 sm:py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-xl sm:rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8 text-white shadow-2xl">
                        <div>
                    ...
                    {/* Filters */}
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8 border border-white/10">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base bg-gray-900 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-white placeholder-gray-500 transition-all duration-300"
                            ...
                            <div>
                                ...
                                <select
                                    className="w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base bg-gray-900 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-white transition-all duration-300"
                        ...
                        {problems.map((problem) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className="block bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-white/10 hover:border-emerald-400/30 transition-all duration-300 hover:scale-[1.01] sm:hover:scale-[1.02]"
                                >
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                        ...
                                        <div className="text-right flex-shrink-0">
                                            ...
                                            {isAuthenticated ? (
                                                <div className={`text-base sm:text-lg font-semibold ${(problem.userStatus === "Solved" || isLocalSolved)
                                                        ? "text-emerald-400"
                        ...
                        <div className="flex justify-center mt-6 sm:mt-8">
                            <nav className="flex flex-wrap items-center justify-center gap-2">
                                <button
                                    ...
                                    className={`px-3 sm:px-4 py-2 text-sm sm:text-base rounded-lg ${pagination.hasPrevPage
                                ...
                                {[...Array(pagination.totalPages)].map((_, index) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-3 sm:px-4 py-2 text-sm sm:text-base rounded-lg ${page === pagination.currentPage
                                ...
                                <button
                                    ...
                                    className={`px-3 sm:px-4 py-2 text-sm sm:text-base rounded-lg ${pagination.hasNextPage
                                            ? "bg-white/10 text-white hover:bg-white/20 border border-white/20"
                                            : "bg-gray-800 text-gray-500 cursor-not-allowed border border-gray-700"
                                        } transition-all duration-300`}
                                >
