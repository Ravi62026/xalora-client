  ...
  const getColorClasses = (color, isPopular) => {
    const colors = {
      gray: {
        ...
        border: isPopular ? "border-indigo-600 ring-2 ring-indigo-600/20" : "border-slate-200 hover:border-slate-300",
        icon: "text-slate-500",
      ...
      blue: {
        ...
        border: isPopular ? "border-blue-500 ring-2 ring-blue-500/20" : "border-slate-200 hover:border-blue-300",
        icon: "text-blue-600",
      ...
      purple: {
        ...
        border: isPopular ? "border-purple-500 ring-2 ring-purple-500/20" : "border-slate-200 hover:border-purple-300",
      ...
      amber: {
        ...
        border: isPopular ? "border-amber-500 ring-2 ring-amber-500/20" : "border-slate-200 hover:border-amber-300",
        icon: "text-amber-600",
        button: "from-amber-600 to-orange-600 hover:from-amber-500 hover:to-orange-500",
        badge: "bg-amber-600",
      },
      cyan: {
        bg: "from-white to-cyan-50/30",
        border: isPopular ? "border-cyan-500 ring-2 ring-cyan-500/20" : "border-slate-200 hover:border-cyan-300",
        icon: "text-cyan-600",
      ...
      indigo: {
        ...
        border: isPopular ? "border-indigo-500 ring-2 ring-indigo-500/20" : "border-slate-200 hover:border-indigo-300",
      ...
      emerald: {
        ...
        border: isPopular ? "border-emerald-500 ring-2 ring-emerald-500/20" : "border-slate-200 hover:border-emerald-300",
      ...
      <div className="min-h-screen xalora-grid-bg py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-black bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 via-blue-600 to-purple-600 mb-4 sm:mb-6">
              Choose Your Plan
            </h1>
            <p className="text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto px-2 mb-8">
            ...
            {activeTab === "individual" && (
              <div className="flex justify-center mb-8">
                <div className="inline-flex items-center bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full border border-slate-200 shadow-sm">
                  <svg className="w-5 h-5 mr-2 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-sm text-slate-800 font-semibold">Monthly Recurring Billing</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {plans.map((plan) => {
              ...
              return (
                <div
                  key={plan.id}
                  className={`relative rounded-2xl shadow-xl overflow-hidden border transition-all duration-500 hover:scale-[1.02] transform-gpu bg-gradient-to-br ${colors.bg} ${colors.border}`}
                >
                  {/* Popular Badge */}
                  {plan.popular && (
                  ...
                  {/* Current Plan Badge */}
                  {isCurrentPlan && (
                    <div className="absolute top-0 left-0 bg-gradient-to-r from-emerald-600 to-teal-600 text-white text-xs font-bold px-5 py-2 rounded-br-xl z-10">
                      YOUR PLAN
                    </div>
                  )}
                  ...
                  <div className="p-6 sm:p-7">
                    ...
                    <div className="flex justify-center mb-4">
                      <div className={`p-3 rounded-2xl bg-white/50 backdrop-blur-sm border border-slate-200`}>
                      ...
                      {price === 0 || price === null ? (
                        <div>
                          {plan.customPricing ? (
                            ...
                            <span className="text-3xl sm:text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-amber-500 to-orange-600">
                              Coming Soon
                            </span>
                          ) : (
                            <span className="text-4xl sm:text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-teal-600">
                              Free
                            </span>
                          )}
                        ...
                        <div>
                          ...
                          <span className="block text-slate-500 text-sm mt-1">
                            ...
                            {plan.monthlyPrice > 0 && (
                              <span className="block text-xs text-emerald-600 font-semibold mt-0.5">Auto-renews monthly</span>
                            )}
                          </span>
                        </div>
                      )}
                    ...
                    {activeTab === "organization" && plan.seats && (
                      <div className="text-center mb-4">
                        <span className="inline-flex items-center px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-sm">
                          <svg className="w-4 h-4 mr-1.5 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                          </svg>
                          Up to <strong className="text-slate-900 ml-1">{plan.seats}</strong> members
                        </span>
                      </div>
                    )}
                    ...
                    {/* Best For */}
                    <div className="rounded-lg p-3 mb-5 bg-slate-50 border border-slate-100">
                    ...
                    <div className="mb-5">
                      ...
                      <ul className="space-y-2">
                        ...
                        {plan.features.length > 5 && (
                          <li className="text-slate-400 text-xs italic pl-6">+ {plan.features.length - 5} more features</li>
                        )}
                      </ul>
                    </div>
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-4 rounded-xl font-bold text-white text-sm transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-slate-100 bg-gradient-to-r ${colors.button} shadow-lg hover:shadow-xl ${
                        isCurrentPlan
          ...
          <div className="mt-16 sm:mt-24 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                ...
                <div key={idx} className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm hover:border-indigo-300 transition-all duration-300">
                  <h3 className="text-base font-bold text-slate-900 mb-2 flex items-center">
                    <svg className={`w-5 h-5 mr-2 text-${faq.icon}-600`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center bg-emerald-50 border border-emerald-200 rounded-full px-6 py-3">
